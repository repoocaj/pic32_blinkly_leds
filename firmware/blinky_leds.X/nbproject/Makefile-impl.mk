...
# All Configurations
ALLCONFS=pic32mx_eth_sk pic32mz_ef_sk pic32mz_da_sk pic32mz_ef_sk_16b pic32mk_evk pic32wk_sk pic32mx_xlp_sk 
...
.clobber-impl: .clobber-pre .depcheck-impl
	    ...
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=pic32mk_evk clean
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=pic32wk_sk clean
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=pic32mx_xlp_sk clean
...
.all-impl: .all-pre .depcheck-impl
	    ...
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=pic32mk_evk build
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=pic32wk_sk build
	    ${MAKE} SUBPROJECTS=${SUBPROJECTS} CONF=pic32mx_xlp_sk build
